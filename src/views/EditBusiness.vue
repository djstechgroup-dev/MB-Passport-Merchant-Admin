<template>
    <main>
        <h1 class="py-3 text-center">The Alabama Theatre</h1>    
        <table class="table table-bordered" style="border: 2px solid;">
            <tbody class="text-center" style="border: 2px solid;">
                ...
                <td>
                    <input type="email" style="width:100%; height: 100%; border:none" placeholder="" value="The Alabama Theatre" /></td>
                ...
                <td><h4>Address</h4></td>
                  <td>
                    <input type="email" style="width:100%; height: 100%; border:none" placeholder="" value="4750 Hwy 17 S, North Myrtle Beach, SC 29582" /></td>
                ...
                <td>                    
                    ...
                    <input type="email" style="width:100%; height: 100%; border:none" placeholder="" value="Today: 9am - 5pm"/> 
               ...
               <td>
                    <input type="email" style="width:100%; height: 100%; border:none" placeholder="" value="https://www.alabama-theatre.com"/></td>
                </tr>
                <tr>
                <td><h4>Image</h4></td>
                <td>
